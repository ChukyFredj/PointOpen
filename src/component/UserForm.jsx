const UserForm = ({ nom, setNom, prenom, setPrenom, annee, setAnnee, ecole, setEcole, logoEcole }) => (
        ...
        <div className="flex flex-col items-center">
            ...
            <div className="mb-4 w-full">
                <button
                    ...
                    className="py-1 px-2 bg-red-500 text-white rounded-md hover:bg-red-600 transition text-center"
                >
                    Supprimer
                </button>
            </div>
